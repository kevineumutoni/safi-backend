...
AUTHENTICATION_BACKENDS = [
    'users.auth_backend.PhoneBackend',  # (see below)
...
LIPANAMPESA_SHORTCODE = os.getenv("LIPANAMPESA_SHORTCODE")
...
TRANSACTION_DESCRIPTION = os.getenv("TRANSACTION_DESCRIPTION")
